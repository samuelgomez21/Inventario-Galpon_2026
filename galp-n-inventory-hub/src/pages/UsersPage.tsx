        ...
        <div className="space-y-3">
          {users.length > 0 ? (
                  ...
                  <div className="flex items-center gap-3 flex-1">
                    ...
                    <div className="flex-1 min-w-0">
                      <div className="flex items-center gap-2 flex-wrap">
                        <p className="font-semibold text-foreground text-base sm:text-lg truncate">{u.nombre}</p>
                        {u.id === currentUser?.id && (
                          <span className="text-xs bg-primary/10 text-primary px-2 py-0.5 rounded-full font-medium">Tú</span>
                        )}
                      </div>
            ...
            <div className="text-center py-16 sm:py-24">
              ...
              <p className="text-muted-foreground mb-4 text-sm sm:text-base">No hay usuarios registrados</p>
              <button
                onClick={handleOpenNewModal}
              ...
              {!editingUser && (
                <div className="p-3 sm:p-4 bg-muted rounded-lg">
                  <p className="text-xs sm:text-sm text-muted-foreground">
                    Al crear el usuario, se enviará un correo de bienvenida con instrucciones para iniciar sesión.
                  </p>
                </div>
              )}
        ...
        <div className="fixed inset-0 bg-black/50 backdrop-blur-sm flex items-center justify-center z-50 p-4">
          <div className="bg-card rounded-xl border border-border p-5 sm:p-6 w-full max-w-md shadow-2xl">
            <div className="mb-5">
              ...
              <h2 className="text-lg sm:text-xl font-bold text-foreground text-center mb-2">Eliminar Usuario</h2>
              <p className="text-sm sm:text-base text-muted-foreground text-center">
                ¿Estás seguro de que deseas eliminar a <span className="font-semibold text-foreground">{deletingUser.nombre}</span>?
              </p>
              <p className="text-xs sm:text-sm text-destructive text-center mt-2">Esta acción no se puede deshacer</p>
            </div>
